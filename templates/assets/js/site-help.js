...
const SiteHelp = {
  pages: {
    ...
    'deployment_validator.html': {
      ...
      summary: 'A live self-test of the deployment: required files, key behaviours, PWA assets, and integration points.',
      sections: [
      ...
      tips: ['Run it once after every deployment or update.']
    }
  },
