...
const CBTChatbot = {
  ...
  kb: [
    ...
    { keywords: ['question types', 'types of questions', '17 types', 'cloze', 'matching', 'matrix', 'hot text'], reply: '**All 17 question types:** MCQ · Multiple Response (all-or-nothing option) · True/False · Short Answer · Numeric (± tolerance) · Matching (with distractors) · Ordering · Assertion–Reason · Case Study/Comprehension · Image MCQ · Matrix/Grid · Hot Text · Code · Cloze multi-blank · Essay (keyword + min-word marking) · Categorization · Multi-part Numeric.\n\nEvery type has a live preview in the Teacher Hub manual builder, and structured types take JSON in the Pairs/Items columns.' },
    ...
    /* ── AI PROMPTS ── */
    { keywords: ['ai prompt', 'chatgpt', 'claude', 'gemini', 'deepseek', 'prompt studio', 'generate questions'], reply: '**AI Prompts Studio (cbt-prompts.html):** 18 tailored prompt packs (simple recall → enterprise all-17-types → multi-subject UTME → misconception hunter → exam-board simulation…). Copy the prompt into any **free** AI chat, paste the answer back, and the validator checks it before loading into your Teacher Hub bank.\n\nNo AI API, no cost — and the 17-column CSV contract is enforced in the prompt itself.' },
